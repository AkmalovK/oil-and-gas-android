        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        myEdit.putString("password", usernameString);
                        myEdit.commit();
                        ((TextView)getActivity().findViewById(R.id.settings_password)).setText(sharedPreferences.getString("password", "password"));
                    }
                });
